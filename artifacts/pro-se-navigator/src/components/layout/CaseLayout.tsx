...
import { FileText, Briefcase, Info, FileSearch, ShieldAlert, Scale, CheckSquare, UploadCloud, Mail, BookOpenCheck, CalendarClock, ClipboardList, BrainCircuit, Handshake, Gavel, LibraryBig, CalendarDays, FileStack, Search, Swords } from "lucide-react";
...
export function CaseLayout({ children, caseId, title }: { children: React.ReactNode; caseId: string; title: string }) {
  ...
  const tabs = [
    ...
    { name: "Motions", href: `/cases/${caseId}/motions`, icon: Swords },
